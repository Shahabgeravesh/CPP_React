...
import { StyleSheet, Text, View, SafeAreaView, TouchableOpacity, ScrollView, Alert, FlatList } from "react-native";
...
const App: React.FC = () => {
  ...
  const loadData = async () => {
    try {
      // Clear existing data to ensure new questions load
      await AsyncStorage.removeItem("flashcards");
      ...
      if (savedCards) {
        ...
        // Initialize with exact ASIS CPP certification flashcards from original iOS app
        const sampleCards: Flashcard[] = [
          ...
          {
            id: "3",
            question: "Why is financial planning critical for creating strategies?",
          ...
          {
            id: "4",
            question: "What is the role of budgeting in an organization?",
          ...
          {
            id: "5",
            question: "Why should long-term planning be approached cautiously?",
          ...
          {
            id: "6",
            question: "How does budgeting relate to security management?",
          ...
          {
            id: "8",
            question: "What are variable costs in budgeting?",
          ...
          {
            id: "12",
            question: "How does traditional budgeting differ from zero-based budgeting?",
          ...
          {
            id: "13",
            question: "What does a Profit & Loss (P&L) statement summarize?",
          ...
          {
            id: "16",
            question: "Why is net income important?",
          ...
          {
            id: "18",
            question: "What is the formula for the operating profit margin ratio?",
          ...
          {
            id: "23",
            question: "What is the goal of an Organizational Resilience Management System (ORMS)?",
          ...
          {
            id: "24",
            question: "What are the key components of an ORMS policy?",
          ...
          {
            id: "25",
            question: "Why is adaptability crucial in an ORMS?",
          ...
          {
            id: "26",
            question: "How do performance indicators support an ORMS?",
          ...
          {
            id: "27",
            question: "What is the systems approach in ORMS?",
          ...
          {
            id: "29",
            question: "What are SMART metrics?",
          ...
          {
            id: "30",
            question: "What is the Security Metrics Evaluation Tool (Security MET)?",
          ...
          {
            id: "31",
            question: "How should data for metrics be collected?",
          ...
          {
            id: "32",
            question: "Why is communicating metrics critical?",
          ...
          {
            id: "34",
            question: "What is the role of hurdle rates in investment decisions?",
          ...
          {
            id: "35",
            question: "Why is cultural awareness important in business practices?",
          ...
          {
            id: "36",
            question: "How does leadership impact risk management?",
          ...
          {
            id: "37",
            question: "What is the role of whistleblower protections?",
          ...
          {
            id: "38",
            question: "What is the significance of ISO 22301?",
          ...
          {
            id: "39",
            question: "How does ISO 31000 relate to risk management?",
          ...
          {
            id: "40",
            question: "Why is GDPR compliance important for businesses?",
          ...
          {
            id: "41",
            question: "What are the benefits of aligning security with corporate governance?",
          ...
          },
          {
            ...
            category: "Vision, Mission, Values",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          },
          ...
          },
          {
            ...
            answer: "To deter, detect, and delay unauthorized access by increasing visibility and reducing hiding places for intruders.",
          ...
          {
            id: "150",
            question: "What are the types of security lighting?",
            answer: "Continuous, standby, movable, and emergency lighting.",
            category: "Physical Security",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          },
          {
            ...
            answer: "strategic Level High level management of the investigative unit ensuring alignment with company leadership and legal counsel Operational Level Deals with investigative policies, case management, reporting, quality control, and evidence handling.\nCase Level – Focuses on specific investigations, investigator assignments, and case management protocols.",
            category: "Investigations",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          },
          {
            ...
            answer: "Have the companys attorney retain it as attorney work product.",
            category: "Investigations",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          {
            id: "279",
            question: "Why should best practices be followed even if a case wont go to trial?",
          ...
          },
          {
            ...
            answer: "A spoken statement regarding a persons knowledge, which may be direct or indirect.",
            category: "Investigations",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          },
          {
            ...
            answer: "Inconsistencies within a witness own statement, between multiple statements, with other testimonies, or with physical evidence.",
            category: "Investigations",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
         ...
         category: "system Design",
          ...
          {
            id: "582",
            question: "What is the primary goal of emergency management?",
            answer: "To detect, contain, and deal with the immediate impact of an event.",
          ...
          {
            id: "583",
            question: "What are the four cyclical elements of emergency management?",
            answer: "Mitigation, Preparedness, Response, and Recovery.",
            category: "Crisis Management",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          {
            id: "584",
            question: "Which term is often used as an umbrella term for risk management, security management, and crisis management?",
            answer: "Resilience.",
            category: "Crisis Management",
            difficulty: "medium",
            isBookmarked: false,
          ...
          {
            id: "585",
            question: "What is the primary focus of crisis management?",
            answer: "Dealing strategically with the numerous issues that could impact the viability of an organization.",
            category: "Crisis Management",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          {
            id: "586",
            question: "What differentiates crisis management from emergency management?",
            answer: "Crisis management includes managing reputational and nonoperational aspects of a business beyond just emergency response.",
            category: "Crisis Management",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          {
            id: "587",
            question: "What is the ultimate goal of crisis management?",
            answer: "To protect core assets such as reputation, brand, financial wellbeing, trust, physical and intellectual property, and key relationships.",
            category: "Crisis Management",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          {
            id: "588",
            question: "What is the role of a crisis management team?",
            answer: "To evaluate and respond to disruptive events to ensure a coordinated response across all organizational functions.",
            category: "Crisis Management",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          {
            id: "589",
            question: "What does business continuity management (BCM) focus on?",
            answer: "Ensuring that business operations can continue or resume after a business interruption.",
            category: "Crisis Management",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          {
            id: "590",
            question: "What are some common business continuity strategies?",
            answer: "Resumption in place, contracting out selected functions, and relocation of critical functions and personnel.",
            category: "Crisis Management",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          {
            id: "591",
            question: "What is the purpose of ISO Standard 22301:2019?",
            answer: "To provide guidelines for security and resilience in business continuity management.",
            category: "Crisis Management",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          {
            id: "592",
            question: "What are the key components of business continuity planning?",
            answer: "Identifying critical business functions, risk assessments, recovery strategies, and testing and maintenance of the plan.",
            category: "Crisis Management",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          {
            id: "593",
            question: "Why is business continuity planning important?",
            answer: "It ensures that an organization can continue operations during and after a crisis event.",
            category: "Crisis Management",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          {
            id: "594",
            question: "What is the first step in business continuity planning?",
            answer: "Conducting a business impact analysis (BIA) to determine critical business functions and potential impacts.",
            category: "Crisis Management",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          {
            id: "595",
            question: "What role does crisis communication play in crisis management?",
            answer: "It helps manage public perception and ensures consistent messaging during a crisis.",
            category: "Crisis Management",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          {
            id: "596",
            question: "What is mitigation in the context of emergency management?",
            answer: "The process of putting protective measures in place to reduce the likelihood or impact of a disaster.",
            category: "Crisis Management",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          {
            id: "597",
            question: "What does preparedness involve in emergency management?",
            answer: "Activities, programs, and systems developed before an incident to support mitigation, response, and recovery.",
            category: "Crisis Management",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          {
            id: "598",
            question: "What is the main objective of the response phase in emergency management?",
            answer: "To execute the emergency plan and protect life and property.",
            category: "Crisis Management",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          {
            id: "599",
            question: "What happens during the recovery phase of emergency management?",
            answer: "The organization re-establishes processes, resources, and capabilities to meet operational requirements.",
            category: "Crisis Management",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          {
            id: "600",
            question: "How does crisis management support business continuity operations?",
            answer: "By ensuring strategic decision-making and coordinated responses across business functions.",
            category: "Crisis Management",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          {
            id: "601",
            question: "What is the primary challenge in crisis evaluation and response?",
            answer: "Making decisions with limited information in a limited timeframe.",
            category: "Crisis Management",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          {
            id: "602",
            question: "What are some key factors that determine if an event qualifies as a crisis?",
            answer: "scope of impact, potential harm to the organization, and need for cross-functional response.",
            category: "Crisis Management",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          {
            id: "603",
            question: "Why is it essential for employees to be trained in crisis reporting and escalation?",
            answer: "To ensure a quick and effective response when a crisis occurs.",
            category: "Crisis Management",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          {
            id: "604",
            question: "What does a business impact analysis (BIA) assess?",
            answer: "The potential consequences of business interruptions and the timeframes for recovery.",
            category: "Crisis Management",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          {
            id: "605",
            question: "How does an organization determine which functions are critical in business continuity planning?",
            answer: "By evaluating the financial, operational, and reputational impact of their disruption.",
            category: "Crisis Management",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          {
            id: "606",
            question: "What is the significance of DRI International Professional Practices for Business Continuity Management?",
            answer: "It provides a widely accepted framework for business continuity planning and implementation.",
            category: "Crisis Management",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          {
            id: "607",
            question: "What is the role of executive leadership in crisis management?",
            answer: "Making strategic decisions to minimize business and reputational impact.",
            category: "Crisis Management",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          {
            id: "608",
            question: "What is an example of a reputational crisis that requires crisis management?",
            answer: "A product recall due to safety concerns.",
            category: "Crisis Management",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          {
            id: "609",
            question: "How does an organization test the effectiveness of its business continuity plan?",
            answer: "By conducting drills, simulations, and tabletop exercises.",
            category: "Crisis Management",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          {
            id: "610",
            question: "Why should organizations integrate business continuity into their corporate culture?",
            answer: "To ensure proactive preparedness and resilience in the face of disruptions.",
            category: "Crisis Management",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          {
            id: "611",
            question: "What is the key difference between disaster recovery and business continuity?",
            answer: "Disaster recovery focuses on restoring IT systems, while business continuity ensures overall business operations resume.",
            category: "Crisis Management",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          {
            id: "612",
            question: "What does the BCI Good Practices Guidelines provide?",
            answer: "Best practices and methodologies for business continuity planning.",
            category: "Crisis Management",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          {
            id: "613",
            question: "How does crisis management help protect brand trust?",
            answer: "By managing communication and response efforts to maintain stakeholder confidence.",
            category: "Crisis Management",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          {
            id: "614",
            question: "What is an example of a non-physical crisis that requires crisis management?",
            answer: "A regulatory investigation into the company's business practices.",
            category: "Crisis Management",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          {
            id: "615",
            question: "What is the primary objective of a crisis communications plan?",
            answer: "To ensure timely and accurate messaging to internal and external stakeholders.",
            category: "Crisis Management",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          {
            id: "616",
            question: "Why is coordination among departments critical in crisis management?",
            answer: "To ensure a unified response and avoid conflicting actions.",
            category: "Crisis Management",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          {
            id: "617",
            question: "What should an organization do immediately after a crisis is resolved?",
            answer: "Conduct a post-crisis evaluation to identify lessons learned and improve future responses.",
            category: "Crisis Management",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          {
            id: "618",
            question: "What type of training is crucial for crisis response teams?",
            answer: "scenario-based training that simulates potential crisis events.",
            category: "Crisis Management",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          {
            id: "619",
            question: "What role does technology play in business continuity?",
            answer: "Ensuring that communication and critical business systems remain operational.",
            category: "Crisis Management",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          {
            id: "620",
            question: "Why is documenting lessons learned after a crisis important?",
            answer: "To improve response strategies and prevent similar issues in the future.",
            category: "Crisis Management",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          {
            id: "621",
            question: "What is the function of an emergency operations center (EOC) during a crisis?",
            answer: "To serve as a centralized hub for managing crisis response efforts.",
            category: "Crisis Management",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          {
            id: "622",
            question: "Why is stakeholder communication essential during a crisis?",
            answer: "To maintain trust and manage expectations among employees, customers, and investors.",
            category: "Crisis Management",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          {
            id: "623",
            question: "What does the ASIS/BSI Business Continuity Management System standard provide?",
            answer: "A structured approach to developing and maintaining a business continuity program.",
            category: "Crisis Management",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          {
            id: "624",
            question: "Why is flexibility important in business continuity planning?",
            answer: "To adapt to different types of crises and evolving threats.",
            category: "Crisis Management",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          {
            id: "625",
            question: "What is the primary challenge in crisis decision-making?",
            answer: "Balancing speed of response with accuracy of information.",
            category: "Crisis Management",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          {
            id: "626",
            question: "What is an example of a cyber-based crisis requiring business continuity planning?",
            answer: "A ransomware attack that shuts down an organization\\s IT infrastructure.",
            category: "Crisis Management",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          {
            id: "627",
            question: "What type of insurance can help mitigate financial losses from a crisis event?",
          ...
          {
            id: "628",
            question: "What is a key characteristic of a successful crisis management program?",
            answer: "Cross-functional collaboration and clear roles and responsibilities.",
            category: "Crisis Management",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
          ...
          {
            id: "629",
            question: "How does business continuity support long-term organizational resilience?",
            answer: "By ensuring that critical operations can continue despite disruptions.",
            category: "Crisis Management",
            difficulty: "medium",
            isBookmarked: false,
            reviewCount: 0
        ...
        await AsyncStorage.setItem("flashcards", JSON.stringify(sampleCards));
      }
                  ...
                  <View style={styles.cardActions}>
                    <TouchableOpacity 
                      ...
                      onPress={() => {
                        ...
                        updatedCards[currentCardIndex].isBookmarked = !updatedCards[currentCardIndex].isBookmarked;
